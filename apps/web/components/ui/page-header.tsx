...
export function PageHeader({
  ...
  return (
    <header className="page-header flex flex-col gap-4 border-b border-border/80 pb-5 sm:flex-row sm:items-end sm:justify-between">
      <div className="max-w-3xl">
        ...
        <p className="mt-2.5 max-w-2xl text-sm leading-6 text-muted-foreground sm:text-base sm:leading-7">{description}</p>
      </div>
