  ...
  return (
    <AbsoluteFill>
      ...
      >
        <Shot>
          <ProductFrame
            screenshot={SCREENSHOTS.task}
            title="Workflow task · LocalGuard AI"
            route="/tasks/…"
            width={1590}
            height={842}
            objectPosition="center center"
      ...
      >
        <Shot>
          <ProductFrame
            screenshot={SCREENSHOTS.audit}
            title="Audit log · LocalGuard AI"
            route="/audit"
            width={1590}
            height={842}
            objectPosition="center center"
      ...
      <div
        style={{
          ...
          opacity: interpolate(frame, [176, 212], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: Easing.bezier(0.16, 1, 0.3, 1),
          }),
          scale: interpolate(frame, [176, 212], [0.86, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
      ...
      >
        ...
        <div>
          ...
          >
            Approval provenance remains attached.
          </div>
        </div>
      </div>
      <div
        style={{
          ...
          letterSpacing: 1.2,
          color: COLORS.mint,
          opacity: interpolate(frame, [420, 456], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
          }),
        }}
